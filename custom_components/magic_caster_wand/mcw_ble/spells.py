...
class Aberto(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "FFDD66", 300).add_delay(200).add_clear()
...
class Brachiabindo(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(250).add_led_hex(LedGroup.TIP, "996633", 300).add_delay(200).add_clear()
...
class Calvorio(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(150).add_led_hex(LedGroup.TIP, "FFEECC", 200).add_delay(150).add_clear()
...
class Colloshoo(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "AA8844", 300).add_delay(200).add_clear()
...
class Densaugeo(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "FFFFCC", 250).add_delay(150).add_clear()
...
class Entomorphis(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "336633", 250).add_delay(150).add_clear()
...
class Langlock(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "AA6666", 250).add_delay(150).add_clear()
...
class Lumos(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(150).add_led(LedGroup.TIP, 255, 255, 255, 2000)
...
class MucusAdNauseum(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "66FF66", 250).add_delay(150).add_clear()
...
class Nox(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(100).add_led_hex(LedGroup.TIP, "330033", 200).add_delay(100).add_clear()
...
class Quietus(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(150).add_led_hex(LedGroup.TIP, "666688", 250).add_delay(150).add_clear()
...
class Scourgify(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(150).add_led_hex(LedGroup.TIP, "88DDFF", 300).add_delay(200).add_clear()
...
class Silencio(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(150).add_led_hex(LedGroup.TIP, "9999AA", 300).add_delay(200).add_clear()
...
class Sonorus(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "FFAA66", 250).add_delay(150).add_clear()
...
class SpellSuccess(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "00FF00", 300).add_delay(200).add_clear()
...
class Spongify(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(150).add_led_hex(LedGroup.TIP, "FFCCFF", 300).add_delay(200).add_clear()
...
class TheHairThickeningGrowingCharm(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "8B4513", 300).add_delay(200).add_clear()
...
class TheSleepingCharm(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(150).add_led_hex(LedGroup.TIP, "6666AA", 400).add_delay(300).add_clear()
...
class TheStretchingJinx(Spell):
    ...
    def payoff(self) -> Macro:
        return Macro().add_buzz(200).add_led_hex(LedGroup.TIP, "FFAA88", 300).add_delay(200).add_clear()
